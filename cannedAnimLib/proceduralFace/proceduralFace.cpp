...
const float ProceduralFace::DefaultSizeXY= IsXray() ? 0.95f : 1.1f; //Default size of the eyes (applies both X and Y)
...
# define CONSOLE_GROUP "Face.ParameterizedFace"
  ...
  CONSOLE_VAR_RANGED(s32, kProcFace_NominalEyeSpacing, CONSOLE_GROUP, IsXray() ? 86 :83, -FACE_DISPLAY_WIDTH, FACE_DISPLAY_WIDTH);  // V1: 64;
